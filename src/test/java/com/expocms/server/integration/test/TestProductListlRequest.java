...
public class TestProductListlRequest {
	public static void main(String[] args) {
		sendRequest();
	}
	public static String sendRequest(){
		HttpClient client = new HttpClient();
		String url = "http://123.57.152.218:38888/app/productList";
		//String url = "http://localhost:8888/app/productDetails";
		PostMethod postMethod = new PostMethod(url);
		postMethod.getParams().setParameter(
				HttpMethodParams.HTTP_CONTENT_CHARSET, "UTF-8");
		ProductListRequest test=new ProductListRequest();
		test.setPage(0);
		test.setPageCount(10);
		test.setProductType("alreadyRepayment");
